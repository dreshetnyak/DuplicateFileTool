...
internal sealed class FileAttributes(uint attributes)
{
    private Win32.FileAttributes Attributes { get; set; } = (Win32.FileAttributes)attributes;
...
{
    public static FileData Empty { get; } = new();
    ...
    private FileData()
    {
        DirPath = FileName = ShortFileName = FullName = Extension = "";
        Attributes = new FileAttributes(0);
        IsEmpty = true;
    }

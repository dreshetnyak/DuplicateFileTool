...
internal sealed class DuplicateFile(DuplicateGroup parentGroup, MatchResult matchResult) : NotifyPropertyChanged
{
    ...
    private DuplicateGroup ParentGroup { get; } = parentGroup;
    public FileData FileData { get; } = matchResult.ComparableFile.FileData;
    public int MatchValue { get; } = matchResult.MatchValue;
    public int CompleteMatch { get; } = matchResult.CompleteMatch;
    public int CompleteMismatch { get; } = matchResult.CompleteMismatch;

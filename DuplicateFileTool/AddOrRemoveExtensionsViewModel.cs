...
internal sealed class AddOrRemoveExtensionsViewModel : IAddOrRemoveExtensionsViewModel
{
    private ExtensionsConfiguration ExtensionsConfig { get; }
    private ObservableCollection<FileExtension> Extensions { get; }

    public ObservableCollection<FileExtension> SelectedExtensions { get; } = [];
    ...
    private static void AddIfMissing(ObservableCollection<FileExtension> extensions, FileExtension fileExtension)
    {
    ...
    private static void RemoveIfPresent(ObservableCollection<FileExtension> extensions, FileExtension fileExtension)
    {
    ...
    private void OnCommandFinishedEvent() => 
